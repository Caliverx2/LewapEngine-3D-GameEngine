...
dependencies {
    ...
    implementation("dev.onvoid.webrtc:webrtc-java:0.1.0")
    runtimeOnly("dev.onvoid.webrtc:webrtc-java-linux-x86_64:0.1.0")
    runtimeOnly("dev.onvoid.webrtc:webrtc-java-windows-x86_64:0.1.0")
